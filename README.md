...
- 空中写真判読による津波浸水域（推定）データ（2024年1月9日更新）
    - 出典：https://www.gsi.go.jp/BOUSAI/20240101_noto_earthquake.html#7
    - 概要：国土地理院が1月2日及び1月5日に撮影した空中写真（正射画像）・（珠洲地区、輪島東地区）から、令和6年能登半島地震によって生じたと考えられる津波到達範囲（堤外地を含む）を判読（一部を再判読）して作成したものです。
...
- 被災後のSAR画像：20240106撮影
    ...
    - 概要：東京大学の渡邉英徳研究室が[Umbraが公開した合成開口レーダー（SAR）画像](https://twitter.com/umbraspace/status/1743677139633717555?s=20)をMapTiler Engineを用いて作成したタイルセットです。
